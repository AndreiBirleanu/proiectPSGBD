...
DECLARE
  ...
  lista_genuri varr := varr('Art Punk','Alternative Rock','Britpunk','College Rock','Crossover Thrash (thx Kevin G)','Crust Punk (thx Haug)','Experimental Rock','Folk Punk','Goth / Gothic Rock','Grunge','Hardcore Punk','Hard Rock','Indie Rock','Lo-fi (hat tip to Ben Vee Bedlamite)','New Wave','Progressive Rock','Acoustic Blues','African Blues','Blues Rock','Blues Shouter','British Blues','Canadian Blues','Chicago Blues','Classic Blues','Classic Female Blues','Contemporary Blues','Contemporary R&B','Country Blues','Delta Blues','Detroit Blues','Electric Blues','Folk Blues','Gospel Blues','Harmonica Blues','Hill Country Blues','Hokum Blues','Jazz Blues','Jump Blues','Kansas City Blues','Louisiana Blues','Memphis Blues','Modern Blues','New Orlean Blues','NY Blues','Piano Blues','Piedmont Blues','Punk Blues','Ragtime Blues (cheers GFS)','Rhythm Blues','Soul Blues','St. Louis Blues','Soul Blues','Swamp Blues','Texas Blues','Urban Blues','Vandeville','West Coast Blues','Club / Club Dance (thx Luke Allfree)','Breakcore','Breakbeat / Breakstep','4-Beat','Acid Breaks','Baltimore Club','Big Beat','Breakbeat Hardcore','Broken Beat','Florida Breaks','Nu Skool Breaks','Brostep (cheers Tom Berckley)','Chillstep (thx Matt)','Deep House (cheers Venus Pang)','Dubstep','Electroswing','Exercise','Future Garage (thx Ran’dom Haug)','Garage','Glitch Hop (cheers Tom Berckley)','Glitch Pop (thx Ran’dom Haug)','Grime (thx Ran’dom Haug / Matthew H)','Hardcore','Bouncy House','Bouncy Techno','Breakcore','Digital Hardcore','Doomcore','Dubstyle','Gabber','Happy Hardcore','Hardstyle','Jumpstyle','Makina','Speedcore','Terrorcore','Uk Hardcore','Hard Dance','Hi-NRG / Eurodance','Horrorcore (thx Matt)','House','Acid House','Chicago House','Deep House','Diva House','Dutch House','Electro House','Freestyle House','French House','Funky House','Ghetto House','Hardbag','Hip House','Italo House','Latin House','Minimal House','Progressive House','Rave Music','Swing House','Tech HouseTribal House','UK Hard House','US Garage','Vocal House','Jackin House (with thx to Jermaine Benjamin Dale Bruce)','Jungle / Drum’n’bass','Liquid Dub(thx Ran’dom Haug)','Speedcore (cheers Matt)','Techno','Acid Techno','Detroit Techno','Free Tekno','Ghettotech','Minimal','Nortec','Schranz','Techno-Dnb','Technopop','Tecno Brega','Toytown Techno','Acid Rock (with thanks to Alex Antonio)','Adult-Oriented Rock (thanks to John Maher)','Afro Punk','Adult Alternative','Alternative Rock (thx Caleb Browning)','American Traditional Rock','Anatolian Rock','Arena Rock','Art Rock','Blues-Rock','British Invasion','Cock Rock','Death Metal / Black Metal','Doom Metal (thx Kevin G)','Glam Rock','Grind Core','Hair Metal','Hard Rock','Math Metal (cheers Kevin)','Math Rock (thx Ran’dom Haug)','Metal','Metal Core (thx Ran’dom Haug)','Jam Bands','Post Punk (thx Ben Vee Bedlamite)','Prog-Rock/Art Rock','Progressive Metal (thx Ran’dom Haug)','Psychedelic','Rock & Roll','Rockabilly (it’s here Mark Murdock!)','Roots Rock','Singer/Songwriter','Southern Rock','Spazzcore (thx Haug)','Stoner Metal (duuuude)','Surf','Technical Death Metal (cheers Pierre)','Tex-Mex','Thrash Metal (thanks to Pierre A)');
...
DBMS_OUTPUT.PUT_LINE('populam tabela artists cu 10.000 entitati...');
   ...
   FOR v_i IN 1..20 LOOP
     ...
     v_length := FLOOR(DBMS_RANDOM.VALUE(1,3));
      ...
      insert into artists values(art_seq.nextval, my_str, sysdate, sysdate);
   END LOOP;
...
DBMS_OUTPUT.PUT_LINE('populam tabela genuri...');
    ...
    FOR v_i IN 1..lista_genuri.count LOOP
      ...
      select replace(v_nume,'’', '') into v_nume from dual;
       select replace(v_nume,'''‘', '') into v_nume from dual;
       
       --SELECT TRANSLATE(v_nume, '’''', ' ') into v_nume FROM DUAL;
